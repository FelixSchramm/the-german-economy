...
- SQL files need to be formatted with `sqlfluff`.

## Commit & Branching Conventions
- Use conventional commits (https://www.conventionalcommits.org/)
- Always work with feature branches
- Pull requests should include a clear description with background and links to
  the relevant data source / request / results.
